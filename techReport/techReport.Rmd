...
## Analysis
The continuous scale was split into a hundred bins. The analysis was pre-registered at \url{AsPredicted.org}.
...
1. Are they completing the strength-of-preference task properly (i.e. not treating it as binary)?
2. RTs?
3. Does total RT change depending on block? Depending on task?
4. Does proportion of time spent staring at stimuli change over time? Over block?
5. How do you tell calibration? What effect does that have? How do you kick people out based on that?! 
6. So. Many. Questions. 
...
Participant 6, 9, 11, 14, 15, 24, 26, 34, 42: calibration and validation seemed to go very well, but fixation cross did not work for them.
